...
class OpenAICallbackHandler(BaseCallbackHandler):
    ...
    def on_llm_end(self, response: LLMResult, **kwargs: Any) -> None:
        ...
        print(f"Report metrics cost issue check: {model_name}, {response.llm_output.get('model_name', '')}, {model_name in MODEL_COST_PER_1K_TOKENS}")
        if model_name in MODEL_COST_PER_1K_TOKENS:
            ...
            print(f"Report metrics cost issue check: completion_cost {completion_cost}, prompt_cost {prompt_cost}, total_cost {self.total_cost}")
